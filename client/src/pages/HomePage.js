            ...
            <Grid item xs={12} md={4}>
              ...
              >
                <Box 
                  ...
                  className="text-fade-in-up"
                  style={{ animationDelay: '0.2s' }}
                  src="/images/JKP_2677.JPG" // Using your local image
                ...
                <Typography variant="body2" className="text-fade-in-up" style={{ animationDelay: '0.4s' }} sx={{ color: '#4A4A4A' }}>
            ...
            <Grid item xs={12} md={4}>
              ...
              >
                <Box 
                  ...
                  className="text-fade-in-up"
                  style={{ animationDelay: '0.2s' }}
                  src="/images/Baho-Night-1-_8.JPG" // Using your local image
            ...
            <Grid item xs={12} md={4}>
              ...
              >
                <Box 
                  ...
                  className="text-fade-in-up"
                  style={{ animationDelay: '0.2s' }}
                  src="/images/JKP_2692.JPG" // Using your local image
                  alt="Baho Events" 
                  sx={{ width: '100%', height: '180px', objectFit: 'cover', borderRadius: 2, mb: 2 }}
                />
                <Typography variant="h5" component="h3" className="text-fade-in-up" style={{ animationDelay: '0.3s' }} gutterBottom sx={{ color: '#01234B', fontWeight: 600 }}>
